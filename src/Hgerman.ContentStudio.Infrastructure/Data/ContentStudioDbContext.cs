...
public class ContentStudioDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VideoJob>(entity =>
        {
            ...
            entity.HasIndex(x => x.AutomationProfileId);

            entity.Property(x => x.JobNo)
                .HasMaxLength(40)
                .IsRequired();
            ...
            entity.Property(x => x.SourcePrompt)
                .HasMaxLength(4000);
            ...
            entity.Property(x => x.VoiceProvider)
                .HasMaxLength(50);

            entity.Property(x => x.VoiceName)
                .HasMaxLength(100);
            ...
            entity.Property(x => x.MotionMode)
                .HasMaxLength(30);

            entity.Property(x => x.RenderProfile)
                .HasMaxLength(30);

            entity.Property(x => x.PublishedUrl)
                .HasMaxLength(1000);

            entity.Property(x => x.ProfileSnapshotJson);
        ...
        modelBuilder.Entity<VideoScene>(entity =>
        {
            ...
            entity.Property(x => x.SceneText)
                .HasMaxLength(2000)
                .IsRequired();

            entity.Property(x => x.ScenePrompt)
                .HasMaxLength(2000);
            ...
            entity.Property(x => x.VisualType)
                .HasMaxLength(30);

            entity.Property(x => x.CameraMotion)
                .HasMaxLength(30);

            entity.Property(x => x.OverlayText)
                .HasMaxLength(120);

            entity.Property(x => x.RenderInstructionsJson);

            entity.Property(x => x.StartSecond)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.EndSecond)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.DurationSecond)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.CropFocusX)
                .HasColumnType("decimal(10,4)");

            entity.Property(x => x.CropFocusY)
                .HasColumnType("decimal(10,4)");

            entity.Property(x => x.MotionIntensity)
                .HasColumnType("decimal(10,4)");

            entity.Property(x => x.OverlayStartSecond)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.OverlayEndSecond)
                .HasColumnType("decimal(10,2)");
        ...
        modelBuilder.Entity<Asset>(entity =>
        {
            ...
            entity.Property(x => x.DurationSec)
                .HasColumnType("decimal(10,2)");
        ...
        modelBuilder.Entity<AutomationProfile>(entity =>
        {
            ...
            entity.Property(x => x.PreferredHoursCsv)
                .HasMaxLength(100)
                .IsRequired();

            entity.Property(x => x.TopicPrompt)
                .HasMaxLength(1000)
                .IsRequired();

            entity.Property(x => x.HookTemplate)
                .HasMaxLength(500);

            entity.Property(x => x.ViralPatternTemplate)
                .HasMaxLength(500);

            entity.Property(x => x.TrendKeywordsCsv)
                .HasMaxLength(500);

            entity.Property(x => x.SeedTopicsCsv)
                .HasMaxLength(1000);

            entity.Property(x => x.GrowthMode)
                .HasMaxLength(30)
                .IsRequired();

            entity.Property(x => x.MinSuccessScore)
                .HasColumnType("decimal(10,2)");
        ...
        modelBuilder.Entity<TrendSnapshot>(entity =>
        {
            ...
            entity.Property(x => x.TrendTitle)
                .HasMaxLength(300)
                .IsRequired();

            entity.Property(x => x.TrendScore)
                .HasColumnType("decimal(10,2)");
        ...
        modelBuilder.Entity<TitlePerformance>(entity =>
        {
            ...
            entity.Property(x => x.OriginalTitle)
                .HasMaxLength(200)
                .IsRequired();

            entity.Property(x => x.CandidateTitle)
                .HasMaxLength(200)
                .IsRequired();

            entity.Property(x => x.HookType)
                .HasMaxLength(100);

            entity.Property(x => x.PatternType)
                .HasMaxLength(100);

            entity.Property(x => x.PredictedScore)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.ActualScore)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.ClickThroughRate)
                .HasColumnType("decimal(10,4)");

            entity.Property(x => x.AvgWatchSeconds)
                .HasColumnType("decimal(10,2)");

            entity.Property(x => x.RetentionRate)
                .HasColumnType("decimal(10,4)");
        ...
        modelBuilder.Entity<AutomationFeedback>(entity =>
        {
            ...
            entity.Property(x => x.FeedbackType)
                .HasMaxLength(50)
                .IsRequired();
            ...
            entity.Property(x => x.ScoreValue)
                .HasColumnType("decimal(10,2)");
